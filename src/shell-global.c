...
/**
 * shell_global_get_active_workspace:
 *
 * Return value: (transfer none): The current #MetaWorkspace
 */
MetaWorkspace *
shell_global_get_active_workspace (ShellGlobal *global)
{
  return meta_workspace_manager_get_active_workspace (global->workspace_manager);
}
